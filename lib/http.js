...
export class HttpClient {
   ...
   */
  static async get(config, interceptors) {
  ...
  constructor(config, interceptors = {}) {
    ...
    this.interceptors = this.super.InterceptorsSchema.parse(interceptors);
  }
...
const r = await HttpClient.send({ origin: "https://developer.mozilla.org" });
