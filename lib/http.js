...
export class HttpRequest extends Request {
  ...
  constructor(input, init = {}) {
    ...
    super(input, { ...rest, body: json ? json : body });
...
export class HttpClient {
  ...
  static async send($config = {}, $interceptors = {}) {
    const { origin, path, ...init } = this.ConfigSchema.parse(
      this.mergeConfig(this.defaults, $config),
    );
    const interceptors = this.InterceptorsSchema.parse($interceptors);
  ...
  send(config = {}, interceptors) {
    return this.super.send(this.super.mergeConfig(this.defaults, config), interceptors);
  }
  ...
  get(config = {}, interceptors) {
    return this.super.get(this.super.mergeConfig(this.defaults, config), interceptors);
  }
  ...
  post(config = {}, interceptors) {
    return this.super.post(this.super.mergeConfig(this.defaults, config), interceptors);
  }
